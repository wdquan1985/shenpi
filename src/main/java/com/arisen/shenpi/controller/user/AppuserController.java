package com.arisen.shenpi.controller.user;
...
import com.arisen.shenpi.controller.BaseController;
import com.arisen.shenpi.model.Page;
import com.arisen.shenpi.model.system.Role;
import com.arisen.shenpi.service.system.AppuserManager;
import com.arisen.shenpi.service.system.RoleManager;
import com.arisen.shenpi.util.AppUtil;
import com.arisen.shenpi.util.MD5;
import com.arisen.shenpi.util.ObjectExcelView;
...
//		logBefore(logger, Jurisdiction.getUsername()+"新增会员");
		logBefore(logger, SpringSecuritySession.getUsername()+"新增会员");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
