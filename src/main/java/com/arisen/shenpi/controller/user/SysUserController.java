...
import com.arisen.shenpi.service.system.FHlogManager;
import com.arisen.shenpi.service.system.UserManager;
		...
		try{
			if(Tools.checkKey("USERNAME", pd.getString("FKEY"))){	//检验请求key值是否合法
				if(AppUtil.checkParam("registerSysUser", pd)){		//检查参数
					...
					HttpSession session = SpringSecuritySession.getSession();
